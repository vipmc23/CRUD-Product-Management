...
<%--        <form:input type="text" path="ma_size" class="form-control"/>--%>
<%--        <form:errors element="p" path="ma_size"/>--%>
    </div>
    <div class="mb-3">
...
<table class="table table-striped">
    ...
    <c:forEach items="${size}" var="s">
        <tr>
            ...
            <td>${s.trang_thai}</td>
            <td>
                <a href="/size/delete?id=${s.id}" class="btn btn-danger">Delete</a>
                <a href="/size/detail?id=${s.id}" class="btn btn-warning">Detail</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
