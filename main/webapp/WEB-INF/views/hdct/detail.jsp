...
<form action="/hdct/update" method="post">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="id" value="${hdct.id}" readonly>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select id="disabledSelect" class="form-select" name="ctsp">
            <c:forEach items="${lopCTSP}" var="cp">
                <option value="${cp.id}"
                    ${cp.id == hdct.ctsp.id ? 'selected' :''}
                >${cp.id}</option>
            </c:forEach>
        </select>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="gia_ban" value="${hdct.gia_ban}">
    </div>
    <div class="mb-3">
        <label class="form-label">Tổng Tiền</label>
        <input type="text" class="form-control" name="tong_tien" value="${hdct.tong_tien}">
    </div>
    <div class="row">
        ...
        <div class="form-check col-4">
            ...
            ${hdct.trang_thai == 'Active' ? 'checked' :''}
            >
        ...
        <div class="form-check col-4">
            ...
            ${hdct.trang_thai == 'Inactive' ? 'checked' :''}
            >
            <label class="form-check-label">
                Inactive
            </label>
