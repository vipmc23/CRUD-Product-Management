...
<form action="/hoa-don/update" method="post">
    ...
    <div class="mb-3">
        ...
        <select id="disabledSelect" class="form-select" name="khachHang">
            <c:forEach items="${lopKH}" var="kh">
                <option value="${kh.id}"
                    ${kh.id == hd.khachHang.id ? 'selected' :''}
                >${kh.ho_ten}</option>
            </c:forEach>
        </select>
    </div>
    <div class="row">
        ...
        <div class="form-check col-4">
            ...
            ${hd.trang_thai == 'Inactive' ? 'checked' :''}
            >
            <label class="form-check-label">
                Inactive
            </label>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="dia_chi" value="${hd.dia_chi}">
    </div>
    <div class="mb-3">
        <label class="form-label">Số Điện Thoại</label>
        <input type="text" class="form-control" name="so_dien_thoai" value="${hd.so_dien_thoai}">
    </div>
